         ...
         <div class="card-body">
             <form action="{{ route('kamar.store') }}" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                     ...
                     <input type="text" id="tipe" name="tipe" class="form-control" placeholder="Tipe kamar">
                 </div>
                 <div class="form-group">
                     <label for="harga">Harga</label>
                     <input type="text" id="harga" name="harga" class="form-control" placeholder="Harga kamar">
                 </div>
                 <div class="form-group">
                     <label for="deskripsi">Deskripsi</label>
                     <textarea id="deskripsi" name="deskripsi" class="form-control" placeholder="Deskripsi kamar"></textarea>
                 </div>
                 <div class="form-group">           
